...
// 	f.SetRGBFillColor(TableCellBG()) // background color for every other cell
...
// 			f.SetMarginLeft(x)
// 			f.SetMarginRight(pageWidth - (x + width))
// 			drawContent(f, cell, 12)
// 		}
// 		f.SetMargins(20, 20, 20, 20)
// 		f.Ln(-1)
// 		fill = !fill
// 	}
...
// 	pdf, err := gofpdf.New("P", "mm", "Letter", "")
// 	if err != nil {
// 		log.Println(err)
// 	}
// 	Setup(pdf)
...
// 		if pdf.Y()+height > lib.ContentBoxBottom(pdf) {
// 			pdf.AddPage()
// 			y = pdf.Y()
// 		}
...
// // https://github.com/ISeeMe/gofpdf/blob/master/fpdf_test.go#L525
...
// 		// add a new page if the height of the row doesn't fit on the page
// 		if f.Y()+height > pageHeight-bottomMargin {
// 			f.AddPage()
// 			y = f.Y()
// 		}
